...
public class ScheduleController {
    ...
    public ResponseEntity<DataResponseDTO<List<GetScheduleResponseDTO>>> getSchedule(HttpServletRequest request,
    ...
    public ResponseEntity<DataResponseDTO<String>> editSchedule(HttpServletRequest request, @PathVariable Long projectId,
